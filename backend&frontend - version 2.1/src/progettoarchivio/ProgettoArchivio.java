...
public class ProgettoArchivio {
    ...
    private static GestoreArchivi gestore = GestoreArchivi.getInstance();  //getInstance() gives access to that one object.
    // Catalog for managing the subjects (soggetti), like people, places, Politician, objects.
