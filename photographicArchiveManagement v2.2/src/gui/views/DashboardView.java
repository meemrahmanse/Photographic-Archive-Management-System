...
public class DashboardView extends JPanel {
    ...
    private JPanel createQuickActionsSection() {
        ...
        acts.add(createActionButton("New Archive", Theme.ACCENT_COLOR, Color.WHITE));
        acts.add(createActionButton("Upload Photograph", Theme.CARD_BG, Theme.TEXT_PRIMARY));
        acts.add(createActionButton("Manage Subjects", Theme.CARD_BG, Theme.TEXT_PRIMARY));
        acts.add(createActionButton("Generate Report", Theme.CARD_BG, Theme.TEXT_PRIMARY));
